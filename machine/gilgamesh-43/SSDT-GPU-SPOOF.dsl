...
// Path is `_SB_.PCI0.SF0_.S08_.S80_`.
// Path is `PciRoot(0x0)/Pci(0x1E,0x0)/Pci(0x1,0x0)/Pci(0x10,0x0)`.
DefinitionBlock ("", "SSDT", 2, "DRTNIA", "AMDGPU", 0x00001000)
{
    External (_SB_.PCI0, DeviceObj)
    External (_SB_.PCI0.SF0_.S08_.S80_, DeviceObj)


    Scope (\_SB_.PCI0.SF0_.S08_.S80_)
    {
        if (_OSI ("Darwin"))
        {
